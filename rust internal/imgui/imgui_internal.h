...
#define IM_ASSERT_USER_ERROR(_EXP,_MSG)  // Recoverable User Error
#endif

// Misc Macros
#define IM_PI                           3.14159265358979323846f
#ifdef _WIN32
#define IM_NEWLINE                      xorstr_("\r\n")   // Play it nice with Windows users (Update: since 2018-05, Notepad finally appears to support Unix-style carriage returns!)
#else
#define IM_NEWLINE                      "\n"
#endif
#define IM_TABSIZE                      (4)
...
#define ImFabs(X)           base::memory::_fabsf(X)
#define ImSqrt(X)           base::memory::_sqrtf(X)
#define ImFmod(X, Y)        base::memory::_fmodf((X), (Y))
#define ImCos(X)            base::memory::_cosf(X)
#define ImSin(X)            base::memory::_sinf(X)
#define ImAcos(X)           base::memory::_acosf(X)
#define ImAtan2(Y, X)       base::memory::_atan2f((Y), (X))
#define ImAtof(STR)         base::memory::_atof((STR))
//#define ImFloorStd(X)     floorf(X)           // We use our own, see ImFloor() and ImFloorSigned()
#define ImCeil(X)           base::memory::_ceilf(X)
static inline float  ImPow(float x, float y)    { return base::memory::_powf(x, y); }          // DragBehaviorT/SliderBehaviorT uses ImPow with either float/double and need the precision
static inline double ImPow(double x, double y)  { return base::memory::_pow(x, y); }
static inline float  ImLog(float x)             { return base::memory::_log((double)x); }             // DragBehaviorT/SliderBehaviorT uses ImLog with either float/double and need the precision
static inline double ImLog(double x)            { return base::memory::_log(x); }
static inline int    ImAbs(int x)               { return x < 0 ? -x : x; }
static inline float  ImAbs(float x)             { return base::memory::_fabsf(x); }
static inline double ImAbs(double x)            { return base::memory::_fabs(x); }
...
#endif
static inline double ImRsqrt(double x)          { return 1.0 / ImSqrt(x); }
#endif
...
struct IMGUI_API ImBitArray
{
    ...
    void            ClearAllBits()              { base::memory::_memset(Storage, 0, sizeof(Storage)); }
    void            SetAllBits()                { base::memory::_memset(Storage, 255, sizeof(Storage)); }
...
struct IMGUI_API ImBitVector
{
    ...
    void            Create(int sz)              { Storage.resize((sz + 31) >> 5); base::memory::_memset(Storage.Data, 0, (size_t)Storage.Size * sizeof(Storage.Data[0])); }
...
struct ImSpanAllocator
{
    ...
    ImSpanAllocator()                               { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiComboPreviewData
{
    ...
    ImGuiComboPreviewData() { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiMenuColumns
{
    ...
    ImGuiMenuColumns() { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiInputTextState
{
    ...
    ImGuiInputTextState()                   { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct ImGuiPopupData
{
    ...
    ImGuiPopupData()    { base::memory::_memset(this, 0, sizeof(*this)); OpenFrameCount = -1; }
};
...
struct ImGuiNextWindowData
{
    ...
    ImGuiNextWindowData()       { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct ImGuiNextItemData
{
    ...
    ImGuiNextItemData()         { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct ImGuiLastItemData
{
    ...
    ImGuiLastItemData()     { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiStackSizes
{
    ...
    ImGuiStackSizes() { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct ImGuiInputEvent
{
    ...
    ImGuiInputEvent() { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiListClipperData
{
    ...
    ImGuiListClipperData()          { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct ImGuiOldColumnData
{
    ...
    ImGuiOldColumnData() { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiOldColumns
{
    ...
    ImGuiOldColumns()   { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiWindowSettings
{
    ...
    ImGuiWindowSettings()       { base::memory::_memset(this, 0, sizeof(*this)); }
...
struct ImGuiSettingsHandler
{
    ...
    ImGuiSettingsHandler() { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiStackLevelInfo
{
    ...
    ImGuiStackLevelInfo()   { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiStackTool
{
    ...
    ImGuiStackTool()        { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiContextHook
{
    ...
    ImGuiContextHook()          { base::memory::_memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiContext
{
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas)
    {
        ...
        base::memory::_memset(DragDropPayloadBufLocal, 0, sizeof(DragDropPayloadBufLocal));
        ...
        base::memory::_memset(FramerateSecPerFrame, 0, sizeof(FramerateSecPerFrame));
        FramerateSecPerFrameIdx = FramerateSecPerFrameCount = 0;
        FramerateSecPerFrameAccum = 0.0f;
        WantCaptureMouseNextFrame = WantCaptureKeyboardNextFrame = WantTextInputNextFrame = -1;
        base::memory::_memset(TempBuffer, 0, sizeof(TempBuffer));
    }
};
...
struct ImGuiTabItem
{
    ...
    ImGuiTabItem()      { base::memory::_memset(this, 0, sizeof(*this)); LastFrameVisible = LastFrameSelected = -1; NameOffset = -1; BeginOrder = IndexDuringLayout = -1; }
};
...
struct IMGUI_API ImGuiTable
{
    ...
    ImGuiTable()                { base::memory::_memset(this, 0, sizeof(*this)); LastFrameActive = -1; }
...
struct IMGUI_API ImGuiTableTempData
{
    ...
    ImGuiTableTempData()        { base::memory::_memset(this, 0, sizeof(*this)); LastTimeActive = -1.0f; }
};
...
struct ImGuiTableSettings
{
    ...
    ImGuiTableSettings()        { base::memory::_memset(this, 0, sizeof(*this)); }
